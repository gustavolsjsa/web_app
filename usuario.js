...
lib.ssMetadata = [
		...
		{name:"usuario_atlas_2", frames: [[0,0,1080,1920]]},
		{name:"usuario_atlas_3", frames: [[0,0,1080,1920]]}
];
...
(lib.registromdpi = function() {
	this.initialize(ss["usuario_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_hamburguesa_1},{t:this.instance_2}]}).to({state:[{t:this.btn_hamburguesa_1},{t:this.instance_2}]},104).wait(1));
