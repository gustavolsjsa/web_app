...
lib.ssMetadata = [
		{name:"confMaceta_atlas_1", frames: [[1083,0,308,161],[1083,163,308,161],[0,0,1081,1921]]}
];
...
(lib.config_macetamdpi = function() {
	this.initialize(ss["confMaceta_atlas_1"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
(lib.gr_escribir = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AsVDyIAAnjIYrAAIAAHjg");
...
p.nominalBounds = new cjs.Rectangle(-79,-24.2,158.1,48.5);


(lib.gr_confMaceta = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.config_macetamdpi();
	this.instance.setTransform(-540.5,-960.5);
...
p.nominalBounds = new cjs.Rectangle(-540.5,-960.5,1081,1921);


(lib.gr_borrar = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AxUEcIAAo3MAipAAAIAAI3g");
...
p.nominalBounds = new cjs.Rectangle(-110.8,-28.4,221.7,56.9);
...
(lib.btn_nullcopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CC0000").s().p("ArSLTIAA2lIWlAAIAAWlg");
	this.shape.setTransform(72.275,72.275);
...
if (reversed == null) { reversed = false; }
	...
	// interactivo
	this.btn_juegos = new lib.btn_nullcopy();
	this.btn_juegos.name = "btn_juegos";
	this.btn_juegos.setTransform(813.35,1774.05);
	new cjs.ButtonHelper(this.btn_juegos, 0, 1, 2, false, new lib.btn_nullcopy(), 3);

	this.btn_comunidad = new lib.btn_nullcopy();
	this.btn_comunidad.name = "btn_comunidad";
	this.btn_comunidad.setTransform(580.9,1775.45);
	new cjs.ButtonHelper(this.btn_comunidad, 0, 1, 2, false, new lib.btn_nullcopy(), 3);

	this.btn_perfil = new lib.btn_nullcopy();
	this.btn_perfil.name = "btn_perfil";
	this.btn_perfil.setTransform(367.85,1774.05);
	new cjs.ButtonHelper(this.btn_perfil, 0, 1, 2, false, new lib.btn_nullcopy(), 3);

	this.btn_camara = new lib.btn_nullcopy();
	this.btn_camara.name = "btn_camara";
	this.btn_camara.setTransform(224.15,1847.75,1,1,0,0,0,72.3,72.3);
	new cjs.ButtonHelper(this.btn_camara, 0, 1, 2, false, new lib.btn_nullcopy(), 3);
...
// stage content:
(lib.confMaceta = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.mc_hamburguesa},{t:this.mc_menuinf}]},68).wait(59));

	// escribir2
	this.instance = new lib.gr_escribir("synched",0);
	this.instance.setTransform(522,979.85);
	this.instance._off = true;
	...
	// borrar
	this.gr_borrar1 = new lib.gr_borrar("synched",0);
	this.gr_borrar1.name = "gr_borrar1";
	this.gr_borrar1.setTransform(683.8,984.05);
	this.gr_borrar1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.gr_borrar1).wait(40).to({_off:false},0).to({x:553.8},14).wait(72).to({startPosition:0},0).wait(1));

	// confMaceta
	this.gr_confMaceta1 = new lib.gr_confMaceta("synched",0);
	this.gr_confMaceta1.name = "gr_confMaceta1";
	this.gr_confMaceta1.setTransform(539.5,959.5);
	this.gr_confMaceta1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.gr_confMaceta1).to({alpha:1},30).wait(96).to({startPosition:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(539,959,541,961);
// library properties:
lib.properties = {
