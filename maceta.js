...
lib.ssMetadata = [
		{name:"maceta_atlas_1", frames: [[0,0,1081,1921]]}
];
...
(lib.config_macetamdpi = function() {
	this.initialize(ss["maceta_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// maceta
	this.instance_2 = new lib.config_macetamdpi();
	this.instance_2.setTransform(-1,-1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(47).to({_off:false},0).wait(104).to({_off:true},1).wait(21));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/maceta_atlas_1.png", id:"maceta_atlas_1"}
	],
	preloads: []
};
