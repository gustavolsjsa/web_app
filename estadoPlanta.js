...
lib.ssMetadata = [
		{name:"estadoPlanta_atlas_1", frames: [[0,0,1080,1920]]}
];
...
(lib.estado_plantamdpi = function() {
	this.initialize(ss["estadoPlanta_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.gr_estadoPlanta = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.estado_plantamdpi();
...
// stage content:
(lib.estadoPlanta = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(71).call(this.frame_71).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.mc_hamburguesa},{t:this.mc_menuinf}]},71).wait(59));

	// estado_planta
	this.instance = new lib.gr_estadoPlanta("synched",0);
	this.instance.setTransform(540,960);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},30).wait(100));
