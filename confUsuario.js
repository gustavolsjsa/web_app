...
lib.ssMetadata = [
		{name:"confUsuario_atlas_1", frames: [[0,0,1080,1920]]}
];
...
(lib.gr_confUsuario = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.config_usuariomdpi();
...
// stage content:
(lib.confUsuario = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
